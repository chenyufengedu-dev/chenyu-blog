...
> 📌 **新窗口先读这里**：读完本文建立全局观后，**当前主战场（Cyber Office 视觉/动画/场景大改造）的最新进度与续接说明见 [`HANDOFF-cyber-office-art.md`](./HANDOFF-cyber-office-art.md)**——那里有美术资产现状、流水线脚本、场景/角色渲染细节、可调常量、剩余任务。
